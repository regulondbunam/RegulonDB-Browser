...
export default function OperonViews({ loading = false, dispatch, state }) {
        ...
        <div>
          {loading ? (<>
            ...
            <Typography variant="relevant" component="div">
              {state.resultsSearch === null ? state.geneList.length : state.resultsSearch.list.length}{" operons"}
            </Typography>
          )}
        </div>
        <div>
